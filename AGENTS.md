...
- **README.md** (symlink → `memory/README.md`) — visão geral e status
- **HANDOFF.md** (symlink → `memory/HANDOFF.md`) — estado da sessão
- **memory/MEMORY.md** — índice de memórias do projeto
